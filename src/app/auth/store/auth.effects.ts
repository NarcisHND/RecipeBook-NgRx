...
export class AuthEffects {
  ...
  authSignup = this.actions$.pipe(
    ...
    switchMap((signupAction: AuthActions.SignupStart) => {
        return this.http.post<AuthResponseData>(
          'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDZsooZ0561oSrEWSINykv_eAPShpD1L2A', {
  ...
  authLogin = this.actions$.pipe(
    ...
    switchMap((authData: AuthActions.LoginStart) => {
      return this.http.post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDZsooZ0561oSrEWSINykv_eAPShpD1L2A',
        {
